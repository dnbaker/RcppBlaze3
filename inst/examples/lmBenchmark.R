...
exprs$blaze3_qr <- expression(.Call('_RcppBlaze3_fastLmPure', PACKAGE = 'RcppBlaze3', mm, y, 0L))
exprs$blaze3_ldlt <- expression(.Call('_RcppBlaze3_fastLmPure', PACKAGE = 'RcppBlaze3', mm, y, 1L))
exprs$blaze3_llt <- expression(.Call('_RcppBlaze3_fastLmPure', PACKAGE = 'RcppBlaze3', mm, y, 2L))
...
.Call("_RcppBlaze3_Blaze3_version", FALSE, PACKAGE = "RcppBlaze3")
