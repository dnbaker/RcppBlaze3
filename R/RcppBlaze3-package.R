...
#'
#' RcppBlaze3 construct a bridge between R and Blaze.
#'
...
#'      (\strong{Boost} threads is disables in \strong{RcppBlaze3})
...
#' }
#'
#' The \strong{RcppBlaze3} package includes the header files from the \strong{Blaze} library with disabling some
#' functionalities related to link to the thread and system libraries which make \strong{RcppBlaze3} be a
#' header-only library. Therefore, users do not need to  install \strong{Blaze} and the dependency \strong{Boost}.
#' \strong{Blaze} is licensed under the New (Revised) BSD license, while \strong{RcppBlaze3}
...
#'
#' RcppBlaze3 will follow the latest version of Blaze, If you are looking for a C++98 compatible Blaze,
#' you might consider using RcppBlaze.
#'
#' @section Caution:
...
#'
#' @section Using RcppBlaze3:
#' The simplest way to get started is to create a skeleton of a package
#' using \code{RcppBlaze3}. This can be done conveniently by the
#' \code{\link{RcppBlaze3.package.skeleton}}
#' function.
#'
#' The important steps are
#' \enumerate{
#' \item Include the \samp{RcppBlaze3.h} header file, which also includes \samp{blaze/Blaze.h}.
#' \item Import \code{Rcpp}, LinkingTo \code{Rcpp}, \code{BH} and \code{RcppBlaze3} by adding these lines to the \samp{DESCRIPTION} file:
#' \preformatted{
#'   Imports: Rcpp (>= 0.11.0)
...
#'
#' @author
#' For RcppBlaze3: Chingchuan Chen
